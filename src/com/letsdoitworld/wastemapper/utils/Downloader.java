  ...
  public static JSONObject getJSONObject(String url, double lat, double lon) {
    ...
    try {
      ...
      if (entity != null) {
        ...
        return json;
        /*
         * // A Simple JSONObject Parsing JSONArray nameArray=json.names();
         * JSONArray valArray=json.toJSONArray(nameArray); for(int
         * i=0;i<valArray.length();i++) {
         * Log.i(MainService.TAG,"<jsonname"+i+">\n"
         * +nameArray.getString(i)+"\n</jsonname"+i+">\n"
         * +"<jsonvalue"+i+">\n"+valArray.getString(i)+"\n</jsonvalue"+i+">"); }
         * // A Simple JSONObject Value Pushing json.put("sample key",
         * "sample value");
