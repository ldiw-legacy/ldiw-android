...
public class ShowPoint2Activity extends Activity {
	...
	private Runnable getInfo = new Runnable(){
		...
		public void run() {
			...
			url = (String) sharedPool.get(MainService.API_BASE_URL_KEY) + AppConstants.ADDRESS_WASTE_POINT_DETAILS + url + ".html&max_width="+(int)width + AppConstants.ADDRESS_LANGUAGE +(String) sharedPool.get(AppConstants.SP_LANGUAGE);
